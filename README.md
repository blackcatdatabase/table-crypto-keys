...
> Lineage: 2 outbound / 4 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 9 · Changelog: fresh (2 d)
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package crypto-keys -Apply
