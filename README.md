...
> 🔥 Lineage hotspot: 6 FK links detected. Make sure cascades/nullability are intentional.
...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 2 outbound / 4 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 9 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\crypto-keys](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\crypto-keys)
...
graph LR
  ...
  key_usage["key_usage"]:::inbound -->|FK| crypto_keys
...
- Outbound (depends on): "crypto_keys", "users"
- Inbound (relies on this): "book_assets", "crypto_keys", "key_events", "key_usage"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package crypto-keys -Apply
