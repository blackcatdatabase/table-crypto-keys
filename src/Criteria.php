...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'basename', 'version', 'filename', 'file_path', 'fingerprint', 'key_meta', 'key_type', 'algorithm', 'length_bits', 'origin', 'usage', 'scope', 'status', 'is_backup_encrypted', 'backup_blob', 'created_by', 'created_at', 'activated_at', 'retired_at', 'replaced_by', 'notes' ];
    }
    ...
    {
        $x = [ 'id', 'basename', 'version', 'filename', 'file_path', 'fingerprint', 'key_type', 'algorithm', 'length_bits', 'origin', 'usage', 'scope', 'status', 'is_backup_encrypted', 'created_by', 'created_at', 'activated_at', 'retired_at', 'replaced_by', 'notes' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\CryptoKeys\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\CryptoKeys\Definitions::softDeleteColumn();
