...
final class Definitions {
    ...
    public static function uniqueKeys(): array { return [ [ 'basename', 'version' ], [ 'constraint' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'version', 'length_bits', 'created_by', 'replaced_by' ]; }
