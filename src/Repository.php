...
use BlackCat\Database\Packages\CryptoKeys\Repository\CryptoKeyRepository;
...
{
    private CryptoKeyRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new CryptoKeyRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoKeys\Dto\CryptoKeyDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\CryptoKeys\Dto\CryptoKeyDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\CryptoKeys\Dto\CryptoKeyDto|null
    {
